...
load_dotenv()
import os
# ensure OPENAI_API_KEY is set from CHROMA_OPENAI_API_KEY in .env
_chroma_key = os.getenv("CHROMA_OPENAI_API_KEY")
if _chroma_key:
    os.environ["OPENAI_API_KEY"] = _chroma_key
...
class ChunkRouterAgent(CrewBase):
    ...
    def chunk_diff(
        ...
        # get full git diff via subprocess
